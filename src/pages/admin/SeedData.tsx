  ...
  const seedPageSections = async () => {
    ...
    try {
      const pageSectionsData = [
        ...
        { page_name: "contact", section_key: "social", section_title: "Social Media", content_type: "social", display_order: 3, is_active: true, data: { title: "Connect With Us", description: "Follow us on social media for updates, special offers, and glimpses of our luxury experiences" }},
