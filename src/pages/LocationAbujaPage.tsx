  ...
  useEffect(() => {
    ...
    const initWidget = () => {
      ...
      if (widgetRefDesktop.current) {
        ...
        widgetDivDesktop.id = 'quickbook-widget-681NQfefbo9NUnqk75mBqfu75zYCzgvYvqeExVTYxMzg=-681NQfefbo9NUnqk75mBqfu75zYCzgvYvqeExVTYxMzg=';
      ...
      if (widgetRefMobile.current) {
        ...
        widgetDivMobile.id = 'quickbook-widget-mobile-681NQfefbo9NUnqk75mBqfu75zYCzgvYvqeExVTYxMzg=-681NQfefbo9NUnqk75mBqfu75zYCzgvYvqeExVTYxMzg=';
